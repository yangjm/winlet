...
import com.aggrepoint.winlet.form.Change;
import com.aggrepoint.winlet.form.ChangeDisable;
import com.aggrepoint.winlet.form.ChangeEnable;
 ...
 */
public class Form0Impl implements Form0 {
	/** 表单的ID */
	String id;
	/** 表单对应的操作 */
	String strAction;
	...
	Method actionMethod;
	/**
	 * 尝试将当前表单失效的请求的id。 用于在表单没有制定resetref的情况下，实现自动清空表单
	 * 
	...
	public Form0Impl(String id, Object winlet) {
		this.id = id;
		this.winlet = winlet;
	}
	...
	public void removeChange(Change change) {
		if (vecChanges != null)
			vecChanges.removeAll(Change.find(vecChanges, change.getType(),
					change.getInput()));
	}
